...
# la siguiente url contiene el archivo CSV del 09 de octubre de 2021
# con la información correspondiente , la cual va a ser modificada
url_covid <- 'https://datos.covid-19.conacyt.mx/Downloads/Files/Casos_Diarios_Municipio_Confirmados_20211009.csv'

# igualemnte con la función gsub, reemplazamos ahora 
# en la url los ultimos valores por la fecha actuañ
url_covid <- gsub("20211009", fecha_yesterday, url_covid); url_covid
...
# leemos la base de confirmados para obtener solamente a la ciudad de mexico
url_covid2 <- 'https://datos.covid-19.conacyt.mx/Downloads/Files/Casos_Diarios_Estado_Nacional_Confirmados_20211006.csv'
...
write.csv(df, 
          file = 'C:/Users/David/OneDrive/Documentos/DAOS curses/Datalab SDC4/demo 1/liquibase-covid/code daos/confirmados mun.csv', 
          row.names = F)
